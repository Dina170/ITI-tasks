...
<body>
<form class="w-50 mx-auto mt-3" method="POST" action="update.php" enctype="multipart/form-data">

<div class="mb-3">
    <img src="./img/<?= $data['img'] ?>" alt="<?= $data['img'] ?>" width=200 height=200>
  </div>
<div class="mb-3">
