...
<body>
<form class="w-50 mx-auto mt-3" method="POST" action="list.php" enctype="multipart/form-data">
  <div class="mb-3">
  ...
  <?php
    if(isset($errors['img'])) {
      echo "<p class='text-danger'>".$errors['img']."</p>";
    }
  ?>
  <div class="mb-3">
  ...
  <?php
    if(isset($errors['fname'])) {
      echo "<p class='text-danger'>".$errors['fname']."</p>";
    }
  ?>
  <div class="mb-3">
  ...
  <?php
    if(isset($errors['lname'])) {
      echo "<p class='text-danger'>".$errors['lname']."</p>";
    }
  ?>
  <div class="mb-3">
